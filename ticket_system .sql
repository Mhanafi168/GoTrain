...
(74, 'BK-6824B9D59C2BA', 8, 'Aswan Station', 'Misr Station', '2025-05-14 17:42:13', '17:15:00', 'second', 616.00, 'Aswan-Cairo Sleeper', '89', 'Confirmed', 1, 'one-way', NULL, '2025-05-14 15:42:13'),
(75, 'BK-6824BB5497401', 8, 'Aswan Station', 'Misr Station', '2025-05-15 17:15:00', '17:15:00', 'second', 616.00, 'Aswan-Cairo Sleeper', '89', 'Upcoming', 1, 'one-way', NULL, '2025-05-14 15:48:36'),
(76, 'BK-6824BB8224551', 8, 'Aswan Station', 'Misr Station', '2025-05-29 17:15:00', '17:15:00', 'second', 616.00, 'Aswan-Cairo Sleeper', '89', 'Upcoming', 1, 'one-way', NULL, '2025-05-14 15:49:22');
...
(10, 1, 73, '2025-05-14 04:56:37', 'Significant Delay', 'the train delayed about 1 hour', 'REJECTED', NULL, NULL, NULL, '2025-05-14 16:30:47', '2025-05-14 04:56:37', '2025-05-14 16:30:47');
...
(7, '88', 'Misr Station', 'Aswan Station', '2024-05-15 19:30:00', '2024-05-16 09:20:00', '2025-05-23 20:59:00', '2025-05-16 20:59:00', 'cancelled', 'Sleeper car assignments at information desk.', '2025-05-14 04:04:07', '2025-05-14 17:59:10'),
...
(11, '916', 'Sidi Gaber Station', 'Misr Station', '2025-05-22 19:23:00', '2025-05-28 19:23:00', '2025-05-15 20:58:00', '2025-05-15 20:58:00', 'delayed', NULL, '2025-05-14 16:23:15', '2025-05-14 17:58:42'),
(12, '916', 'Sidi Gaber Station', 'Misr Station', '2025-05-22 19:23:00', '2025-05-28 19:23:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'On Time', NULL, '2025-05-14 16:23:22', '2025-05-14 16:23:22');
...
(56, 8, 'ACCOUNT_RECHARGE', 10000.00, NULL, NULL, 'Wallet recharge', '2025-05-14 15:42:04', ''),
(57, 8, 'BOOKING_PAYMENT', 616.00, NULL, NULL, 'Ticket payment for Booking BK-6824B9D59C2BA', '2025-05-14 15:42:13', ''),
(58, 8, 'BOOKING_PAYMENT', 616.00, NULL, NULL, 'Ticket payment for Booking BK-6824BB5497401', '2025-05-14 15:48:36', ''),
(59, 8, 'BOOKING_PAYMENT', 616.00, NULL, NULL, 'Ticket payment for Booking BK-6824BB8224551', '2025-05-14 15:49:22', '');
...
INSERT INTO `users` (`user_id`, `username`, `email`, `password`, `balance`, `last_recharge_date`, `roleid`, `role`, `created_at`, `updated_at`) VALUES
(1, 'Abdelazem', 'Abdelaze@gmail.com', 'Se15@g135', 210.00, '2025-05-14', 2, 'user', '2025-05-08 20:11:03', '2025-05-14 16:38:39'),
(8, 'Mohamed', 'Mohamed@gmail.com', 'Se15@g135', 8379.50, '2025-05-14', 2, 'user', '2025-05-08 20:11:03', '2025-05-14 17:48:23'),
(12, 'Mahmoud', 'Mahmoud@gmail.com', 'Se15@g135', 0.00, '2025-05-12', 1, 'admin', '2025-05-08 20:11:03', '2025-05-14 17:48:28'),
(19, 'Yahia', 'yahia@gmail.com', '$2y$10$/s0WsNNNvuMzS.BsNPFEo.9AuGOcc40rR9xOg/Jc1aEtt2AfQD49W', 0.00, NULL, 1, 'admin', '2025-05-08 20:11:03', '2025-05-14 17:50:22'),
(22, 'Tarek', 'Mahmoud@gmail.com', 'Se15@g135', 0.00, '2025-05-06', 3, 'station master', '2025-05-08 20:11:03', '2025-05-14 17:48:31'),
(31, 'Tawfik', 'Tawfik@gmail.com', '$2y$10$1JOlyFN4A99.ughKnZNF2.i4Nz6qosHMNrj2gtCfRrWEJ2D9/Dh7.', 0.00, NULL, 3, 'station master', '2025-05-13 06:26:01', '2025-05-14 17:51:05');
...
--
ALTER TABLE `stations`
  MODIFY `station_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;

--
-- AUTO_INCREMENT for table `station_distances`
--
ALTER TABLE `station_distances`
  MODIFY `distance_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
...
--
ALTER TABLE `transactions`
  MODIFY `transaction_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;
