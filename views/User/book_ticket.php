...
$station_names_map = [];
$fare_rates_config = ['second' => 0.15, 'first' => 0.40];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'book_ticket_confirm') {
    if (!$pdo_connection) {
        ...
        try {
            ...
            if ($total_fare > $current_user_balance) {
                $recharge_url = "/GoTrain/views/User/recharge.php";
                throw new Exception(
    ...
    ");
                ...
                header("Location: /GoTrain/views/ticket/index.php?id=" . urlencode($booking_id));
                exit;
            } else {
...
<body>
    <div class="container booking-container">
        ...
        <div class="text-center mt-4">
            <a href="/GoTrain/views/Dashboard/default.php" class="btn btn-sm btn-outline-secondary">
