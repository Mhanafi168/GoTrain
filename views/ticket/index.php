...
require_once ROOT_PATH . '/config/DBController.php';
require_once ROOT_PATH . '/controllers/TicketController.php';
...
if (!isset($_SESSION['user_id'])) {
    ...
    header("Location: /GoTrain/views/auth/login.php"); 
    exit;
}
...
<body>
    <div class="container ticket-page-container">
        <div class="d-flex justify-content-between align-items-center mb-4 page-header">
            ...
            <a href="/GoTrain/views/Dashboard/default.php" class="btn btn-outline-secondary btn-sm">
        ...
        <?php if ($page_info_message): ?>
             <div class="alert alert-info" role="alert">
                 ...
                 <?php if (strpos($page_info_message, "You have not booked any tickets yet") !== false): ?>
                    <a href="/GoTrain/views/User/book_ticket.php" class="btn btn-primary btn-sm mt-2 ms-2">Book a New Ticket</a>
                 <?php endif; ?>
            </div>
        <?php endif; ?>
        ...
        <?php elseif (!$page_info_message && !$page_error_message): ?>
            <div class="alert alert-secondary text-center">
                ...
                <a href="/GoTrain/views/User/book_ticket.php" class="btn btn-primary">Book Your First Ticket</a>
            </div>
        <?php endif; ?>
    </div>
