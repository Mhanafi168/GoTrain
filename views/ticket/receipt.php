    ...
    <div class="container">
        <?php if ($page_error_message): ?>
            <div class="alert alert-danger mt-4" role="alert">
                ...
                <a href="../Dashboard/index.php" class="btn btn-info btn-sm print-hide"><i class="bi bi-house-door"></i> Dashboard</a>
            </div>
        <?php elseif ($single_ticket_details): ?>
            <div class="ticket-receipt-wrapper mt-4">
                ...
                <div class="text-center mt-4 mb-5 print-hide ">
                    ...
                    <a href="../Dashboard/index.php" class="btn btn-secondary"><i class="bi bi-house-door me-1"></i> Dashboard</a>
                </div>
            </div>
